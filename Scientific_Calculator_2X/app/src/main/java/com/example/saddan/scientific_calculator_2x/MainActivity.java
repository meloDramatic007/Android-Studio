package com.example.saddan.scientific_calculator_2x;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        int i = view.getId();
        if (i == R.id.btn_one || i == R.id.btn_two || i == R.id.btn_three || i == R.id.btn_four || i == R.id.btn_five || i == R.id.btn_six || i == R.id.btn_seven || i == R.id.btn_eight || i == R.id.btn_nine || i == R.id.btn_zero) {
            if (!newOperand) {
        ...
        } else if (i == R.id.btn_minus || i == R.id.btn_plus || i == R.id.btn_divide || i == R.id.btn_multiplication) {
            if (!newOperand) {
                newOperand = true;
